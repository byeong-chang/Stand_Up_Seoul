...
# 맛집정보
df = pd.read_csv('C:/last_project/MangoPlate/data/지하철역별맛집정보최종_20230531.csv')
table_name = 'restaurant'
uploadToMysql(df, table_name)

# 운영 시간
run_time = pd.read_csv('C:/last_project/MangoPlate/data/지하철역별맛집운영시간_20230531.csv')
table_name = 'restaurant_runtime'
uploadToMysql(run_time, table_name)

# 휴무 시간
break_time = pd.read_csv('C:/last_project/MangoPlate/data/지하철역별맛집휴식시간_20230531.csv')
