        ...
        with open('/var/lib/airflow/data/서울시 주요 48장소.txt', 'r') as file:
            for place in file:
                try:
                    ...
                    if None in [place_id, area_congest_id, area_ppltn_min, area_ppltn_max, 
                                ...
                                non_resnt_ppltn_rate, ppltn_time, created_date]:
                ...
                # 각 for문 별 예외처리 추가(슬랙 메세지, 에러 로그 추가)
                    ...
                    error_message = f"Warning - Population : An error occurred for place '{place}':\n```\n{e}\n```"
